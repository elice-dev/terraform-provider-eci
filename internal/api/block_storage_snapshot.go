...
func (api *APIClient) PostBlockStorageSnapshot(
	...
	resp, err := api.restyClient.R().
		...
		Post(fmt.Sprintf("%s/resource/storage/snapshot", api.pathPrefix))
...
func (api *APIClient) GetBlockStorageSnapshot(
	...
	resp, err := api.restyClient.R().
		...
		Get(fmt.Sprintf("%s/resource/storage/snapshot/%s", api.pathPrefix, id))
...
func (api *APIClient) GetBlockStorageSnapshots(
	...
	resp, err := api.restyClient.R().
		...
		Get(fmt.Sprintf("%s/resource/storage/snapshot", api.pathPrefix))
...
func (api *APIClient) PatchBlockStorageSnapshot(
	...
	resp, err := api.restyClient.R().
		...
		SetBody(params).
		Patch(fmt.Sprintf("%s/resource/storage/snapshot/%s", api.pathPrefix, id))
...
func (api *APIClient) DeleteBlockStorageSnapshot(
	...
	resp, err := api.restyClient.R().
		...
		Delete(fmt.Sprintf("%s/resource/storage/snapshot/%s", api.pathPrefix, id))
